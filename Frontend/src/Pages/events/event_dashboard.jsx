            ...
            <div className="row justify-content-center">
                <div className="col-md-6">
                    <div className="d-grid gap-3">
                        ...
                        {(user?.role === "user") && (
                            <button
                                className="btn "style={{background:"rgb(121, 22, 81)",color:"white"}}
                        ...
                        {user?.role === "user" && (
                            <button
                                className="btn " style={{background:"rgb(180, 9, 112)",color:"white"}}
                        ...
                        {( user?.role === "admin") && (
                            <button
                                className="btn " style={{background:"rgb(227, 86, 171)",color:"white"}}
                                onClick={() => {
